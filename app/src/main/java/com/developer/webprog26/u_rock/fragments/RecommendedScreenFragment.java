...
import com.developer.webprog26.u_rock.mvp.interfaces.fragments_views.RecommendedScreenView;
...
public class RecommendedScreenFragment extends BaseFragment implements RecommendedScreenView{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.recommended_screen_fragment, container, false);
    ...
    protected void setupFragmentComponent() {
        URockApplication.getAppComponent().plus(new RecommendedScreenPresenterModule()).inject(this);
    }
}
