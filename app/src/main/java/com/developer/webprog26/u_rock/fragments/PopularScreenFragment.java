...
public class PopularScreenFragment extends BaseFragment implements PopularScreenView {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.popular_screen_fragment, container, false);
    ...
    protected void setupFragmentComponent() {
        URockApplication.getAppComponent().plus(new PopularScreenPresenterModule()).inject(this);
    }
}
